...
{:name "python"
 ...
 {module (:repeat _statement)
  ...
  assert_statement (:seq "assert" (:seq expression (:repeat (:seq "," expression))))
  ...
  except_clause (:seq
                 "except"
                 (:choice (:token (:prec 1 "*")) :blank)
                 (:choice
                  (:choice
                   (:seq
                    (:field :value expression)
                    (:choice (:seq "as" (:field :alias expression)) :blank))
                   (:seq (:field :value expression) (:repeat (:seq "," (:field :value expression)))))
                  :blank)
                 ":"
                 _suite)
  ...
  type_alias_statement (:prec-dynamic 1 (:seq "type" (:field :left type) "=" (:field :right type)))
  ...
  generic_type (:prec 1 (:seq (:choice identifier (:alias "type" identifier)) type_parameter))
  ...
  parenthesized_expression (:prec 1 (:seq "(" (:choice expression yield) ")"))
  _collection_elements (:seq
                        (:seq
                         (:choice expression yield list_splat parenthesized_list_splat)
                         (:repeat
                          (:seq "," (:choice expression yield list_splat parenthesized_list_splat))))
                        (:choice "," :blank))
  ...
  keyword_identifier (:choice
                      (:prec -3 (:alias (:choice "print" "exec" "async" "await") identifier))
