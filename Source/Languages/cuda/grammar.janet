...
{:name "cuda"
 ...
 {translation_unit (:repeat _top_level_item)
  ...
  preproc_ifdef (:prec 0
                 (:seq
                  ...
                  (:field :alternative
                   (:choice (:choice preproc_else preproc_elif preproc_elifdef) :blank))
                  (:alias (:pattern "#[ \t]*endif") "#endif")))
  preproc_else (:prec 0 (:seq (:alias (:pattern "#[ \t]*else") "#else") (:repeat _top_level_item)))
  preproc_elif (:prec 0
                (:seq
  ...
  attribute_declaration (:choice
                         (:seq "[[" (:seq attribute (:repeat (:seq "," attribute))) "]]")
                         (:seq "[[" (:seq annotation (:repeat (:seq "," annotation))) "]]"))
  ...
  function_declarator (:prec-dynamic 1
  ...
  call_expression (:prec-dynamic 1
                   (:choice
                    (:prec 15
                    ...
                    (:seq
                     (:field :function
                      (:choice
                       primitive_type
                       (:seq (:choice "typename" :blank) splice_type_specifier)))
                          ...
                          (:seq
                           ...
                           (:field :alternative
                            (:choice
                             ...
                             :blank))
                           (:alias (:pattern "#[ \t]*endif") "#endif")))
  preproc_else_in_block (:prec 0
                         (:seq (:alias (:pattern "#[ \t]*else") "#else") (:repeat _block_item)))
  preproc_elif_in_block (:prec 0
                         (:seq
                          (:alias (:pattern "#[ \t]*elif") "#elif")
                          (:field :condition _preproc_expression)
                          "\n"
                          ...
                          (:field :alternative
                           (:choice
                            (:choice
                             ...
                             (:alias preproc_elifdef_in_block preproc_elifdef))
                            :blank))))
  preproc_elifdef_in_block (:prec 0
                            (:seq
                             (:choice
                              (:alias (:pattern "#[ \t]*elifdef") "#elifdef")
                              (:alias (:pattern "#[ \t]*elifndef") "#elifndef"))
  ...
  qualified_identifier (:seq
                        ...
                        (:field :name
                         (:choice
                          ...
                          qualified_identifier
                          template_function
                          (:prec-dynamic 1 (:seq (:choice "template" :blank) identifier))
                          operator_name
                          destructor_name
  ...
  _assignment_expression_lhs (:seq
                              ...
                              (:field :operator
                               (:choice
                                ...
                                "xor_eq"))
                              (:field :right (:choice expression initializer_list)))
  reflect_expression (:prec-right 0 (:seq "^^" (:choice "::" expression type_descriptor)))
  splice_specifier (:seq "[:" expression ":]")
  _splice_specialization_specifier (:seq splice_specifier template_argument_list)
  splice_type_specifier (:prec-right 0 (:choice splice_specifier _splice_specialization_specifier))
  splice_expression (:prec-right 0
                     (:choice splice_specifier (:seq "template" _splice_specialization_specifier)))
  ...
  kernel_call_expression (:prec 1
                          (:seq
                           (:field :function expression)
                           kernel_call_syntax
                           (:field :arguments argument_list)))
  kernel_call_syntax (:seq
                      (:alias (:token (:seq "<" (:pattern "\\s*") "<" (:pattern "\\s*") "<")) "<<<")
                      expression
                      (:repeat (:seq "," expression))
                      (:alias (:token (:seq ">" (:pattern "\\s*") ">" (:pattern "\\s*") ">")) ">>>"))
  launch_bounds (:seq "__launch_bounds__" "(" expression (:choice (:seq "," expression) :blank) ")")}}
