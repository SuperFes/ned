...
# ned: upstream nests the two field alternatives inside one outer
# alternation ([ type: [...] return_type: [...] ]), one level deeper than
# QueryMatcher's measured scope; split into the two patterns it means.
(_
  type: [
