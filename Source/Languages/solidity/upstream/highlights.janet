...
# ned: upstream wraps the typed expression in a group with a trailing
# anchor; the group's anchor is outside QueryMatcher's measured scope and
# the field already pins the position.
