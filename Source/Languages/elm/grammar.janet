...
{:name "elm"
 ...
 :extras [block_comment line_comment (:pattern "[ \\n\\r\\uFEFF\\u2060\\u200B]|\\\\\\r?\\n")]
 :conflicts [[upper_case_qid value_qid]
             [function_call_expr]
             [case_of_expr]
             [_function_call_target _atom]]
 :precedences []
 :externals [_virtual_end_decl
 ...
 :rules
 {file (:seq
        (:choice (:seq (:field :moduleDeclaration module_declaration) _virtual_end_decl) :blank)
        (:choice _import_list :blank)
        (:choice _top_decl_list :blank))
  block_comment (:prec 1 (:seq "{-" _block_comment_content "-}"))
  line_comment (:token (:prec 1 (:seq (:pattern "--") (:repeat (:pattern "[^\\n\\r]")))))
  module_declaration (:prec-left 0
                      (:choice
                       (:seq
                        (:choice port :blank)
                        module
  ...
  exposing_list (:seq
                 ...
                 (:choice
                  ...
                  (:seq
                   ...
                   (:repeat (:seq "," (:choice exposed_value exposed_type exposed_operator)))))
                 ")")
  exposed_value lower_case_identifier
  exposed_type (:seq upper_case_identifier (:choice exposed_union_constructors :blank))
  ...
  _upper_case_identifier_without_leading_whitespace (:token-immediate
                                                     (:pattern "\\p{Lu}[_\\d\\p{L}]*"))
  _lower_case_identifier_without_leading_whitespace (:token-immediate
                                                     (:pattern "\\p{Ll}[_\\d\\p{L}]*"))
  _dot_without_leading_whitespace (:token-immediate ".")
  upper_case_qid (:prec-right 0
                  (:seq
  ...
  value_qid (:choice
             ...
             (:seq
              ...
              (:repeat
               (:seq
                (:alias _upper_case_identifier_without_leading_whitespace upper_case_identifier)
                (:alias _dot_without_leading_whitespace dot)))
              (:alias _lower_case_identifier_without_leading_whitespace lower_case_identifier)))
  field_accessor_function_expr (:seq
                                dot
                                (:alias
  ...
  import_clause (:seq
                 ...
                 (:field :asClause (:choice as_clause :blank))
                 (:field :exposing (:choice exposing_list :blank)))
  ...
  function_declaration_left (:prec 1
                             (:seq
                              lower_case_identifier
                              (:field :pattern
                               (:repeat
  ...
  union_variant (:prec-left 0
                 (:seq
                  (:field :name upper_case_identifier)
                  (:repeat (:choice line_comment _single_type_expression))))
  _more_union_variants (:seq "|" (:field :unionVariant union_variant))
  ...
  type_expression (:seq _type_expression_inner (:repeat (:seq arrow _type_expression_inner)))
  ...
  _single_type_expression (:choice
  ...
  record_type (:seq
               ...
               (:choice
                (:seq
                 (:choice _record_base :blank)
                 (:seq
                  (:field :fieldType field_type)
                  (:repeat (:seq "," (:field :fieldType field_type)))))
                :blank)
               "}")
  field_type (:seq
  ...
  bin_op_expr (:field :part
               (:prec 1
                (:seq _call_or_atom (:prec-right 0 (:repeat1 (:seq operator _call_or_atom))))))
  ...
  function_call_expr (:prec-dynamic 10
                      (:seq (:field :target _function_call_target) (:field :arg (:repeat1 _atom))))
  _function_call_target (:choice
                         field_access_expr
                         value_expr
  ...
  _atom (:choice
         ...
         glsl_code_expr)
  field_access_expr (:prec-left 0
                     (:seq (:field :target _field_access_start) (:repeat1 _field_access_segment)))
  _field_access_start (:prec 1
                       (:choice
                        field_access_expr
                        (:choice value_expr parenthesized_expr record_expr)))
  _field_access_segment (:prec-left 0
                         (:seq
                          (:alias _dot_without_leading_whitespace dot)
                          (:alias
                           _lower_case_identifier_without_leading_whitespace
                           lower_case_identifier)))
  negate_expr (:seq (:alias minus_without_trailing_whitespace operator_identifier) _atom)
  parenthesized_expr (:seq "(" (:field :expression _expression) ")")
  _literal_expr_group (:choice char_constant_expr number_constant_expr string_constant_expr)
  char_constant_expr (:seq
                      (:alias "'" open_char)
                      (:choice
  ...
  string_constant_expr (:choice
                        ...
                        (:seq
                         ...
                         (:repeat
                          (:choice
                           (:alias
                            (:token-immediate (:prec 2 (:repeat1 (:pattern "[^\\\\\"\\n\\r]"))))
                            regular_string_part)
                           string_escape
                           invalid_string_escape))
                         (:alias "\"" close_quote)))
  ...
  list_expr (:seq
             ...
             (:choice
              (:seq
               (:field :exprList _expression)
               (:repeat (:seq "," (:field :exprList _expression))))
              :blank)
             "]")
  record_expr (:seq "{" (:choice _record_inner :blank) "}")
  record_base_identifier lower_case_identifier
  _record_base (:seq (:field :baseRecord record_base_identifier) "|")
  _record_inner (:seq
                 (:choice _record_base :blank)
                 (:seq (:field :field field) (:repeat (:seq "," (:field :field field)))))
  field (:seq (:field :name lower_case_identifier) eq (:field :expression _expression))
  if_else_expr (:seq _if _then (:repeat (:prec-left 0 (:seq "else" _if _then))) _else)
  ...
  case_of_expr (:choice
                (:seq
                 ...
                 (:choice _more_case_of_branches :blank)
                 (:choice _virtual_end_section :blank)
                 ")")
                (:seq
                 case
                 (:field :expr _expression)
                 ...
                 (:choice _more_case_of_branches :blank)
                 _virtual_end_section))
  _more_case_of_branches (:prec-dynamic 6
                          (:repeat1 (:seq _virtual_end_decl (:field :branch case_of_branch))))
  case_of_branch (:seq (:field :pattern pattern) arrow (:field :expr _expression))
  let_in_expr (:seq
               "let"
               _virtual_open_section
               _inner_declaration
               (:choice (:repeat1 (:seq _virtual_end_decl _inner_declaration)) :blank)
               _virtual_end_section
               "in"
               (:field :body _expression))
  _inner_declaration (:choice (:field :valueDeclaration value_declaration) type_annotation)
  pattern (:seq
           (:choice (:field :child cons_pattern) _single_pattern)
           (:choice (:seq as (:field :patternAs lower_pattern)) :blank))
  cons_pattern (:seq
                (:field :part _single_pattern_cons)
                (:seq "::" (:field :part (:choice cons_pattern _single_pattern_cons))))
  _single_pattern_cons (:choice
                        _parenthesized_pattern
                        anything_pattern
                        lower_pattern
                        union_pattern
  ...
  record_pattern (:seq
                  "{"
                  (:seq
                   (:field :patternList lower_pattern)
                   (:repeat (:seq "," (:field :patternList lower_pattern))))
                  "}")
  list_pattern (:seq
                "["
                (:choice
                 (:seq (:field :part pattern) (:repeat (:seq "," (:field :part pattern))))
                 :blank)
                "]")
  union_pattern (:prec-left 0
                 (:seq
  ...
  _union_argument_pattern (:choice
                           anything_pattern
                           lower_pattern
                           tuple_pattern
                           nullary_constructor_argument_pattern
