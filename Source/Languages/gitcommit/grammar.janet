...
{:name "gitcommit"
 ...
 {source (:seq
          (:repeat comment)
          (:choice (:seq (:seq subject (:pattern "\\r?\\n")) (:repeat comment)) :blank)
          (:choice (:seq (:pattern "\\r?\\n") (:alias (:repeat _body_line) message)) :blank)
          (:choice _generated_comments :blank)
          (:choice _scissor :blank))
  subject (:seq
           (:choice
            (:seq (:alias (:choice "fixup!" "amend!") subject_prefix) (:pattern "[\\f\\v ]+"))
            :blank)
           (:choice
            (:seq (:pattern "[^#]") (:pattern "[^\\n\\r]*"))
            (:seq prefix (:pattern "[^\\n\\r]+"))))
  prefix (:seq
          ...
          (:choice (:seq "(" (:alias (:pattern "[^\\n\\r\\(\\)]+") scope) ")") :blank)
          (:choice "!" :blank)
          (:alias (:pattern "[:\\uff1a]") ":"))
  _body_line (:choice message_line breaking_change trailer comment (:pattern "\\r?\\n"))
  message_line (:seq (:seq (:pattern "[^#]") (:pattern "[^\\n\\r]*")))
  trailer (:seq
           (:alias (:pattern "[a-zA-Z-]+[ ]*[:\\uff1a] ") token)
           (:choice (:alias (:pattern "[^\\n\\r]+(\\r?\\n [^\\n\\r]+)*") value) :blank))
  breaking_change (:seq
                   (:alias (:token (:prec 1 (:pattern "BREAKING[- ]CHANGE[ ]*[:\\uff1a] "))) token)
                   (:choice (:alias (:pattern "[^\\n\\r]+(\\r?\\n [^\\n\\r]+)*") value) :blank))
  comment (:seq
           "#"
           (:choice (:pattern "[\\f\\v ]+") :blank)
           (:choice
            (:choice
             (:alias (:pattern "[^\\n\\r:\\uff1a]+[:\\uff1a]\\s*\\r?\\n") title)
             (:token (:prec -1 (:pattern "[^\\n\\r]*\\r?\\n"))))
            :blank))
  _generated_comments (:seq
                       _generated_comment_separator
                       (:repeat (:choice generated_comment (:pattern "\\r?\\n"))))
  generated_comment (:choice
                     (:seq (:pattern "#\\t") _change)
                     (:seq "#    " rebase_command)
                     (:seq
                      (:pattern "#[ ]*")
  ...
  _onbranch (:seq
             (:alias
              (:choice
               ...
               "현재 브랜치 ")
              text)
             (:alias (:pattern "[^\\s'”»\"“]+") branch)
             (:pattern "\\r?\\n"))
  branch (:pattern "[^\\s'”»\"“]+")
  _commit (:pattern "[0-9a-f]{7,40}")
  number (:pattern "\\d+")
  _generated_comment_separator (:seq
                                (:alias
                                 (:choice
                                ...
                                (:pattern "\\r?\\n"))
  _change (:choice
           (:seq (:choice change :blank) (:choice (:pattern "[\\f\\v ]+") :blank) _filepath)
           (:token (:prec -1 (:pattern "[^\\n\\r]+"))))
  change (:field :kind (:choice new modified renamed deleted typechange))
  new (:choice
       "berkas baru:"
       "comhad nua:"
       "fitxer nou:"
  ...
  typechange (:choice
              ...
              "종류 바뀜:")
  _filepath (:seq
             (:alias (:pattern "\\S+") filepath)
             (:choice (:pattern "[\\f\\v ]+") :blank)
             (:choice
              (:seq (:alias "->" arrow) (:pattern "[\\f\\v ]+") (:alias (:pattern "\\S+") filepath))
              :blank)
             (:choice (:alias (:token (:prec -1 (:pattern "[^\\n\\r]+"))) annotation) :blank))
  _scissor (:seq (:alias (:pattern "# -+ >8 -+\\r?\\n") scissor) diff)
  _scissor_generated_comment (:seq
                              "#"
                              (:choice
                               (:choice
                                (:alias (:pattern "[^\\n\\r:\\uff1a]+[:\\uff1a][ ]*") title)
  ...
  _uptodate (:choice
             ...
             (:seq
              "Ваша ветка обновлена в соответствии с «"
              branch
              "».")
  ...
  _behind (:choice
           ...
           (:seq
            "Din gren ligger efter \""
            branch
            "\" med "
            number
            " incheckning, och kan snabbspolas.")
           (:seq
            "Din gren ligger efter \""
            branch
            "\" med "
            number
            " incheckningar, och kan snabbspolas.")
           (:seq
            "Din gren ligger efter ”"
            branch
            "” med "
           ...
           (:seq
            ...
            "', è indietro di "
            number
            " commit e ne posso eseguire il fast forward.")
           (:seq
            "La vostra branca està "
            number
            " comissions per darrere de «"
            branch
            "», i pot avançar-se ràpidament.")
           (:seq
            "La vostra branca està "
            number
           ...
           (:seq
            ...
            "' "
            number
            " lần chuyển giao, và có thể được chuyển-tiếp-nhanh.")
           (:seq
            "Nhánh của bạn đứng đằng sau “"
            branch
            "” "
            number
            " lần chuyển giao, và có thể được chuyển-tiếp-nhanh.")
           ...
           (:seq
            "Teu ramo está atrás de '"
            branch
            "' por "
            number
            " memória, e pode ser avançado.")
           (:seq
            "Teu ramo está atrás de '"
            branch
            "' por "
           ...
           (:seq
            ...
            "' por "
            number
            " commit, y puede ser avanzada rápido.")
           (:seq
            "Tu rama está detrás de '"
            branch
            "' por "
            number
            " commits, y puede ser avanzada rápido.")
           (:seq
            "Twoja gałąź jest za „"
            branch
            "” o "
            number
            " zapis i może zostać przewinięta.")
           (:seq
            "Twoja gałąź jest za „"
            branch
            "” o "
            number
            " zapisy i może zostać przewinięta.")
           (:seq
            "Twoja gałąź jest za „"
            branch
            "” o "
            number
            " zapisów i może zostać przewinięta.")
           (:seq
            "Tá do bhrainse taobh thiar de '"
            branch
            "' faoi "
            number
            " tiomantas, agus is féidir é a luasghéarú ar aghaidh.")
           (:seq
            "Tá do bhrainse taobh thiar de '"
            branch
            "' faoi "
            number
            " tiomnuithe, agus is féidir é a luasghéarú ar aghaidh.")
           (:seq
            "Votre branche est en retard sur '"
            branch
            "' de "
            number
           ...
           (:seq
            ...
            "' de "
            number
            " commits, et peut être mise à jour en avance rapide.")
           (:seq
           ...
           (:seq
            "Ο κλάδος σας είναι πίσω από το '"
            branch
            "' κατά "
            number
            " υποβολές, και μπορεί να κάνει ταχεία προώθηση.")
           (:seq
            "Ο κλάδος σας είναι πίσω από το '"
            branch
            "' κατά "
            number
            " υποβολή, και μπορεί να κάνει ταχεία προώθηση.")
           (:seq
            "Ваша ветка отстает от «"
            branch
            "» на "
            number
            " коммит и может быть перемотана вперед.")
           (:seq
            "Ваша ветка отстает от «"
            branch
            "» на "
            number
            " коммита и может быть перемотана вперед.")
           (:seq
            "Ваша ветка отстает от «"
            branch
            "» на "
            number
            " коммитов и может быть перемотана вперед.")
           (:seq
            "Ваша гілка відстає від \""
            branch
            "\" на "
            number
           ...
           (:seq
            ...
            "» на "
            number
            " коммит и может быть быстро перемотана.")
           (:seq
            "Ветка отстает от «"
            branch
            "» на "
            number
            " коммита и может быть быстро перемотана.")
           (:seq
            "Ветка отстает от «"
            branch
            "» на "
            number
            " коммитов и может быть быстро перемотана.")
           (:seq
            "Клонът ви е с "
            number
            " подаване зад „"
            branch
            "“ и може да бъде превъртян.")
           (:seq
            "Клонът ви е с "
            number
            " подаване зад „"
            branch
            "“ и може да се превърти.")
           (:seq
            "Клонът ви е с "
            number
            " подавания зад „"
  ...
  _ahead (:choice
          ...
          (:seq
           "Ο κλάδος σας είναι μπροστά από το '"
           branch
           "' κατά "
           number
           " υποβολές.")
  ...
  _rebasing (:choice
             ...
             (:seq
              "Bạn hiện nay đang thực hiện việc “rebase” nhánh “"
              branch
              "” trên “"
              branch
              "”.")
             ...
             (:seq
              "Αυτή τη στιγμή κάνετε rebase τον κλάδο '"
              branch
              "' στο '"
              branch
              "'.")
             (:seq
              "В момента пребазирате клона „"
              branch
              "“ върху „"
              branch
              "“.")
             (:seq
              "Вы сейчас перемещаете ветку «"
              branch
              "» над «"
              branch
              "».")
             (:seq
              "Наразі ви перебазовуєте гілку '"
              branch
              "' на '"
              branch
              "'.")
