...
// language server (see Manager.h's kProseLanguageKey) -- not a hunspell
...
// Manager talks to.
//
// Deliberately its own file rather than folded into ServerConfig.h:
...
// exception in its own file keeps ServerConfig.h's own claim about
// itself true.
//
...
// repeat every frame the way Manager::SyncBuffer's caller runs), else
// std::nullopt.
