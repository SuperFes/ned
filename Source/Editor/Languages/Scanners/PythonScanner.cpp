// The python external scanner, ported from https://github.com/tree-sitter/tree-sitter-python (src/scanner.c, MIT
...
namespace ned::editor::languages::scanners::python {
...
static unsigned Serialize(void* payload_, char* buffer) {
    ...
    uint32_t iter = 1;
    for (; iter < scanner->indents.size && size < kSerializationBufferSize; ++iter) {
...
NED_TREE_SITTER_SCANNER_EXPORTS(python, ned::editor::languages::scanners::python)
