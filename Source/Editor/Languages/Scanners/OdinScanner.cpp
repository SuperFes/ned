// The odin external scanner, ported from https://github.com/tree-sitter-grammars/tree-sitter-odin (src/scanner.c, MIT
...
namespace ned::editor::languages::scanners::odin {
