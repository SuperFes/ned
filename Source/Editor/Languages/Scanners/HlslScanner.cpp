// The hlsl external scanner, ported from https://github.com/tree-sitter-grammars/tree-sitter-hlsl (src/scanner.c, MIT
...
namespace ned::editor::languages::scanners::hlsl {
