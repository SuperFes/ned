// The cuda external scanner, ported from https://github.com/tree-sitter-grammars/tree-sitter-cuda (src/scanner.c, MIT
...
namespace ned::editor::languages::scanners::cuda {
