// The tsx external scanner, ported from its upstream repository (src/scanner.c, MIT
...
namespace ned::editor::languages::scanners::tsx {
...
NED_TREE_SITTER_SCANNER_EXPORTS(tsx, ned::editor::languages::scanners::tsx)
