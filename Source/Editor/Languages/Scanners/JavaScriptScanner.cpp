// The javascript external scanner, ported from https://github.com/tree-sitter/tree-sitter-javascript (src/scanner.c, MIT
...
namespace ned::editor::languages::scanners::javascript {
 ...
 */
static WhitespaceResult scan_whitespace_and_comments(Lexer* lexer, bool* scanned_comment, bool consume) {
...
static bool scan_automatic_semicolon(Lexer* lexer, bool comment_condition, bool* scanned_comment) {
    ...
    for (;;) {
        ...
        if (lexer->isAtIncludedRangeStart(lexer)) {
            return true;
        }
...
static bool scan_html_comment(Lexer* lexer) {
...
NED_TREE_SITTER_SCANNER_EXPORTS(javascript, ned::editor::languages::scanners::javascript)
