// The cpp external scanner, ported from https://github.com/tree-sitter/tree-sitter-cpp (src/scanner.c, MIT
...
namespace ned::editor::languages::scanners::cpp {

using namespace ned::editor::parse::scanner;

enum TokenType { RAW_STRING_DELIMITER,
                 RAW_STRING_CONTENT };
...
static bool scan_raw_string_delimiter(Scanner* scanner, Lexer* lexer) {
...
static bool scan_raw_string_content(Scanner* scanner, Lexer* lexer) {
...
static bool Scan(void* payload_, Lexer* lexer, const bool* valid_symbols) {
    ...
    if (valid_symbols[RAW_STRING_DELIMITER]) {
        lexer->resultSymbol = RAW_STRING_DELIMITER;
...
static unsigned Serialize(void* payload_, char* buffer) {
    VoidPtr payload{payload_};
    static_assert(MAX_DELIMITER_LENGTH * sizeof(wchar_t) < kSerializationBufferSize,
...
NED_TREE_SITTER_SCANNER_EXPORTS(cpp, ned::editor::languages::scanners::cpp)
