// The starlark external scanner, ported from https://github.com/tree-sitter-grammars/tree-sitter-starlark (src/scanner.c, MIT
...
namespace ned::editor::languages::scanners::starlark {
