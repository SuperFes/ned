...
constexpr Entry kC[] = {
    ...
    {"cast_expression", DelimiterKind::Bracket, true, false},
    {"compound_literal_expression", DelimiterKind::Bracket, true, false},
    {"compound_statement", DelimiterKind::Bracket, true, true},
...
constexpr Entry kCpp[] = {
    ...
    {"constraint_conjunction", DelimiterKind::Bracket, true, false},
    {"constraint_disjunction", DelimiterKind::Bracket, true, false},
    {"declaration_list", DelimiterKind::Bracket, true, true},
    ...
    {"for_range_loop", DelimiterKind::Bracket, false, true},
    {"for_statement", DelimiterKind::Bracket, false, true},
    {"generic_expression", DelimiterKind::Bracket, false, false},
    {"gnu_asm_expression", DelimiterKind::Bracket, false, true},
    {"gnu_asm_input_operand", DelimiterKind::Bracket, false, false},
...
constexpr Entry kCsharp[] = {
    ...
    {"using_statement", DelimiterKind::Bracket, false, true},
    {"while_statement", DelimiterKind::Bracket, false, false},
...
constexpr Entry kGo[] = {
    {"argument_list", DelimiterKind::Bracket, true, true},
    {"array_type", DelimiterKind::Bracket, true, false},
    {"block", DelimiterKind::Bracket, true, true},
    {"expression_switch_statement", DelimiterKind::Bracket, false, true},
    {"field_declaration_list", DelimiterKind::Bracket, true, true},
    {"implicit_length_array_type", DelimiterKind::Bracket, true, false},
    ...
    {"map_type", DelimiterKind::Bracket, false, false},
    {"parameter_list", DelimiterKind::Bracket, true, true},
    {"parenthesized_expression", DelimiterKind::Bracket, true, false},
    ...
    {"slice_type", DelimiterKind::Bracket, true, false},
...
constexpr Entry kJava[] = {
    ...
    {"block", DelimiterKind::Bracket, true, true},
    {"cast_expression", DelimiterKind::Bracket, true, false},
    {"catch_clause", DelimiterKind::Bracket, false, false},
    ...
    {"enhanced_for_statement", DelimiterKind::Bracket, false, true},
...
constexpr Entry kJavascript[] = {
    ...
    {"for_in_statement", DelimiterKind::Bracket, false, true},
    {"for_statement", DelimiterKind::Bracket, false, true},
    {"formal_parameters", DelimiterKind::Bracket, true, true},
...
constexpr Entry kLua[] = {
    ...
    {"field", DelimiterKind::Bracket, true, false},
    {"for_statement", DelimiterKind::Keyword, true, true, "for", "end"},
...
constexpr Entry kPhp[] = {
    ...
    {"cast_expression", DelimiterKind::Bracket, true, false},
    {"cast_variable", DelimiterKind::Bracket, true, false},
    {"catch_clause", DelimiterKind::Bracket, false, true},
    {"compound_statement", DelimiterKind::Bracket, true, true},
    {"declaration_list", DelimiterKind::Bracket, true, true},
    ...
    {"member_call_expression", DelimiterKind::Bracket, false, false},
    ...
    {"nullsafe_member_call_expression", DelimiterKind::Bracket, false, false},
    {"parenthesized_expression", DelimiterKind::Bracket, true, false},
    {"property_hook_list", DelimiterKind::Bracket, true, true},
    {"scoped_call_expression", DelimiterKind::Bracket, false, false},
    {"switch_block", DelimiterKind::Bracket, true, true},
...
constexpr Entry kTsx[] = {
    ...
    {"index_signature", DelimiterKind::Bracket, false, true},
    {"interface_body", DelimiterKind::Bracket, true, true},
    {"jsx_expression", DelimiterKind::Bracket, true, true},
    {"jsx_opening_element", DelimiterKind::Bracket, true, true},
