...
Theme DarkTheme() {
    return Theme{
        ...
        .inlayHintForeground           = Color::RGB(0x757bab),
        .inlayHintParameterForeground  = Color::RGB(0x666a92),
        .codeLensForeground            = Color::RGB(0x5f8fb5),
        .codeActionHintForeground      = Color::RGB(0xffcb6b),
        ...
        .unseenContentIndicator        = Color::RGB(0x4fd6c0),
...
Theme LightTheme() {
    ...
    return Theme{
        ...
        .inlayHintForeground           = Color::RGB(0x9a9ab8),
        .inlayHintParameterForeground  = Color::RGB(0xaaaac4),
        .codeLensForeground            = Color::RGB(0x5a7da8),
        .codeActionHintForeground      = Color::RGB(0xb07d12),
        ...
        .unseenContentIndicator        = Color::RGB(0x0e8a7d),
